...
export default function Icon() {
  return (
       <div className='flex flex-row justify-start items-start gap-6'>
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://mail.google.com/mail/?view=cm&fs=1&to=medlynhan@gmail.com" className='no-underline text-inherit cursor-auto'><MdEmail className='icon lg:text-3xl hover:text-(--yellow) transition duration-150'/></a>
       </div>
  );
};
