...
export default function Home() {
  return (
    <div  className="border xs:xs-container sm:sm-container md:md-container lg:lg-container xl:xl-container xl2:xl2-container xl3:xl3-container">Hello im madeline</div>
  ...
  //       <Toogle></Toogle>
  //       <div className="grid-areas-layout xs:max-w-[16em]  sm:max-w-full flex flex-col gap-2 flex flex-col justify-start items-start">
